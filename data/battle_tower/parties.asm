...
BattleTowerMons1:							;NU
	...
	db LEFTOVERS
	db FIRE_SPIN, HORN_DRILL, SPARK, JUMP_KICK
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons2:						;NU2
	...
	db MURKROW	;2-1	
	db LEFTOVERS
	db PROTECT, EMBER, SOFTBOILED, FLY
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SUDOWOODO			;2-4
	db LEFTOVERS
	db SPIKES, ROCK_SMASH, AGILITY, EARTHQUAKE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
...
;2-7
	...
	db EXEGGUTOR	;2-8
	db LEFTOVERS
	db LEECH_SEED, DRAGONBREATH, FLAMETHROWER, PSYCHIC_M
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db BEEDRILL		;2-9
	db GOLD_BERRY
	db THIEF, HYPER_BEAM, HORN_DRILL, SWORDS_DANCE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db MANTINE			;6-16
	db MYSTIC_WATER
	db BUBBLE, ICE_BEAM, PECK, RAIN_DANCE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
...
BattleTowerMons3:				;NUBL (roughly. magneton is uu and raich is nubl)
	...
	db MAGNETON		;3-1
	db LEFTOVERS
	db THUNDERBOLT, TRI_ATTACK, SUBSTITUTE, FLASH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db NINETALES					;3-8
	db SCOPE_LENS
	db FIRE_BLAST, MEDITATE, PSYCHIC_M, SOLARBEAM
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db RAICHU			;3-11
	db FOCUS_BAND
	db THUNDER, REFLECT, SURF, RAIN_DANCE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db LANTURN								;3-15
	db LEFTOVERS
	db SURF, THUNDERBOLT, THUNDER_WAVE, SUBSTITUTE
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons9:	;OU + UBERS
	...
	db MUK		;9-21
	db LEFTOVERS
	db TOXIC, SLUDGE_BOMB, DISABLE, FIRE_PUNCH
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons10:			;UBERS
	...
	db HOUNDOOM		;10-1
	db MINT_BERRY
	db BEAT_UP, FLAMETHROWER, SOLARBEAM, SUNNY_DAY
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db RAIKOU;			;10-4
	db LEFTOVERS
	db THUNDERBOLT, MEDITATE, THUNDER_WAVE, SHADOW_BALL
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db TAUROS	;10-5
	db KINGS_ROCK
	db HYPER_BEAM, EARTHQUAKE, IRON_TAIL, BATON_PASS
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ARCANINE			;10-6
	db MIRACLEBERRY
	db SACRED_FIRE, EXTREMESPEED, IRON_TAIL, OUTRAGE
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db CHARIZARD			;10-7
	db SCOPE_LENS
	db FLAMETHROWER, EARTHQUAKE, SLASH, TWISTER
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
...
;
	...
	db GENGAR;was110misdreavus			;10-12
	db SPELL_TAG
...
;
	db SNEASEL					;10-13
	db SCOPE_LENS
	db SLASH, ICE_PUNCH, SWORDS_DANCE, FURY_SWIPES
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
...
;
	...
	db SUICUNE						;10-21
	db LEFTOVERS
	db SURF, RAIN_DANCE, MEDITATE, ICE_BEAM
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 30000
