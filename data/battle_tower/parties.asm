...
BattleTowerMons1:
	...
	db ESPEON
	db LEFTOVERS
	db BONE_CLUB, PSYCHIC_M, AMNESIA, GROWTH
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db UMBREON
	db LEFTOVERS
	db SHADOW_BALL, IRON_TAIL, CURSE, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db HOUNDOUR
	db LEFTOVERS
	db BEAT_UP, SOLARBEAM, FIRE_SPIN, SUNNY_DAY
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db GIRAFARIG
	db KINGS_ROCK
	db PSYBEAM, BATON_PASS, CRUNCH, AGILITY
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
	...
	db BLISSEY
	db LEFTOVERS
	db SEISMIC_TOSS, SOFTBOILED, THUNDER_WAVE, STRENGTH
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 32000
	...
	db EXEGGUTOR
	db KINGS_ROCK
	db SLEEP_POWDER, GIGA_DRAIN, THIEF, CONFUSION
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
;BattleTowerMons10:
	...
	db SCIZOR
	db POISON_BARB
	db COMET_PUNCH, HYPER_BEAM, SLUDGE_BOMB, SWORDS_DANCE
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
