...
CometPunchDescription:
	db   "A punch with"
	next "raised priority.@"

MegaPunchDescription:
	db   "A powerful punch."
	next "1/3 ATK-up rate.@"
...
SandAttackDescription:
	db   "An attack with 1/2"
	next "chance to flinch.@"

HeadbuttDescription:
	db   "An attack with 1/3"
	next "chance to flinch.@"
