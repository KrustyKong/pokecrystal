...
; entries correspond to constants/move_constants.asm
	...
	move WING_ATTACK,  EFFECT_ALL_UP_HIT,         60, FLYING,    100, 15,  25
	...
	move POISON_STING, EFFECT_POISON_HIT,         80, POISON,    100, 35,  30
	...
	move BONE_CLUB,    EFFECT_FLINCH_HIT,         65, ROCK,     85, 20,  10
