...
; entries correspond to constants/move_constants.asm
	move POUND,        EFFECT_PARALYZE_HIT,         40, NORMAL,    100, 35,   30
	...
	move WING_ATTACK,  EFFECT_ALL_UP_HIT,         60, FLYING,    100, 15,  25		;Aerial Ace
	...
	move VINE_WHIP,    EFFECT_PARALYZE_HIT,       55, GRASS,     100, 10,  33
	move STOMP,        EFFECT_STOMP,              65, NORMAL,    100, 20,  30
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         30, FIGHTING,  100, 30,   0
	move MEGA_KICK,    EFFECT_ALL_UP_HIT,        120, NORMAL,     75,  5,  40
	move JUMP_KICK,    EFFECT_JUMP_KICK,         100, FIGHTING,   95, 25,   0
	move ROLLING_KICK, EFFECT_ROLLOUT,            30, FIGHTING,   85, 15,  30
	move SAND_ATTACK,  EFFECT_FLINCH_HIT,         20, GROUND,    100, 15,  50
	move HEADBUTT,     EFFECT_FLINCH_HIT,         70, NORMAL,    100, 15,  30
	move HORN_ATTACK,  EFFECT_DEFENSE_DOWN_HIT,   75, NORMAL,    100, 25,  50
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          15, NORMAL,     85, 20,   0
	move HORN_DRILL,   EFFECT_NORMAL_HIT,         80, GROUND,    100, 15,  50
	move TACKLE,       EFFECT_NORMAL_HIT,         35, NORMAL,     95, 35,   0
	move BODY_SLAM,    EFFECT_PARALYZE_HIT,       85, NORMAL,    100, 15,  30
	move WRAP,         EFFECT_TRAP_TARGET,        55, NORMAL,     90, 20,   0
	...
	move POISON_STING, EFFECT_POISON_HIT,         80, POISON,    100, 20,  30
	move TWINEEDLE,    EFFECT_POISON_MULTI_HIT,   40, BUG,       100, 20,  40
	...
	move HYDRO_PUMP,   EFFECT_RECOIL_HIT,        110, WATER,      100,  8,   0
	move SURF,         EFFECT_NORMAL_HIT,         95, WATER,      100, 15,   0
	move ICE_BEAM,     EFFECT_FLINCH_HIT,         80, ICE,        100, 10,  10
	move BLIZZARD,     EFFECT_FREEZE_HIT,        110, ICE,         90,  5,  10		;[I] Accuracy
	move PSYBEAM,      EFFECT_SP_DEF_DOWN_HIT,    65, PSYCHIC,    100, 20,  66
	...
	move SUBMISSION,   EFFECT_NORMAL_HIT,         85, FAIRY,   100, 10,   0		;Play Rough
	...
	move STRENGTH,     EFFECT_DEFENSE_UP_HIT,     80, NORMAL,    100, 15,  50
	...
	move SOLARBEAM,    EFFECT_SOLARBEAM,         60, GRASS,      100, 10,   0	;
	move POISONPOWDER, EFFECT_NORMAL_HIT,          70, GRASS,       100, 15,   0	;leaf blade
	...
	move FIRE_SPIN,  EFFECT_RECOIL_HIT,        	 110, FIRE,    100, 15,   0			;Flare Blitz
	...
	move THUNDER,      EFFECT_THUNDER,            60, ELECTRIC,   100, 10,  30		;nerf
	...
	move DOUBLE_TEAM,  EFFECT_EVASION_DOWN,          0, NORMAL,      100, 15,   0
	...
	move EGG_BOMB,     EFFECT_DEFENSE_DOWN_HIT,  100, NORMAL,    100, 10,  40
	...
	move BONE_CLUB,    EFFECT_LEECH_HIT,          80, ROCK,       100, 10,   0			;Power Gem
	move FIRE_BLAST,   EFFECT_BURN_HIT,          110, FIRE,        85,  5,  30		
	move WATERFALL,    EFFECT_FLINCH_HIT,         80, WATER,     100, 15,  20
	move CLAMP,        EFFECT_DEFENSE_DOWN_HIT,   85, WATER,     100, 15,  20
	...
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     10, NORMAL,    100, 35,  100
	move AMNESIA,      EFFECT_SP_DEF_UP_2,         0, PSYCHIC,     100, 20,   0
	move KINESIS,      EFFECT_EVASION_DOWN_2,      0, PSYCHIC,      100, 15,   0
	move SOFTBOILED,   EFFECT_HEAL,                0, NORMAL,      100, 10,   0
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,         120, FIGHTING,   90, 20,   0
	move GLARE,        EFFECT_PARALYZE,            0, NORMAL,       90, 30,   0			;glare
	move DREAM_EATER,  EFFECT_DREAM_EATER,       120, PSYCHIC,    100, 15,   0
	move POISON_GAS,   EFFECT_POISON,              0, POISON,       55, 40,   0
	move BARRAGE,      EFFECT_MULTI_HIT,          27, STEEL,     100, 10,   0			;flash cannon
	...
	move BUBBLE,       EFFECT_FLAME_WHEEL,        80, WATER,      100, 15,  30
	...
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          20, DARK,     100, 15,   0
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         50, GROUND,     90, 10,   0
	move REST,         EFFECT_HEAL,                0, PSYCHIC,     100, 10,   0
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,      100, 10,  25
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, NORMAL,     90, 15,  40
	move SHARPEN,      EFFECT_ATTACK_UP,           0, NORMAL,      100, 30,   0
	move CONVERSION,   EFFECT_CONVERSION,          0, NORMAL,      100, 30,   0
	move TRI_ATTACK,   EFFECT_TRI_ATTACK,         80, NORMAL,     100, 10,  45
	...
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,        15, FIGHTING,   90, 10,   0
	move THIEF,        EFFECT_THIEF,              65, DARK,        100, 10, 100
	...
	move POWDER_SNOW,  EFFECT_PARALYZE_HIT,       80, ELECTRIC,    100, 15,  10		;DISCHARGE
	...
	move OCTAZOOKA,    EFFECT_POISON_HIT,         80, WATER,       85, 10,  50
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,      100, 20,   0
	move ZAP_CANNON,   EFFECT_RECOIL_HIT,        105, ELECTRIC,    100, 15,   0		;Wild Charge
	...
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     70, STEEL,      90, 25,  40
	...
	move HEAL_BELL,    EFFECT_HEAL_BELL,           0, NORMAL,      100,  8,   0
	...
	move MAGNITUDE,    EFFECT_SPEED_DOWN_HIT,     60, GROUND,    100, 20,   0		;Bulldoze
	move DYNAMICPUNCH, EFFECT_LEECH_HIT,          75, FIGHTING,  100, 10,   0		;Drain Punch
	move MEGAHORN,     EFFECT_RECOIL_HIT,        120, BUG,       100, 10,   0
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,	  85, STEEL,     100, 15,  20
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      65, STEEL,     100, 15,  50
	...
	move CROSS_CHOP,   EFFECT_RECOIL_HIT,        100, FIGHTING,   100,  5,   0
	...
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   40, FIGHTING,  100, 15, 100
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        55, WATER,       85, 15,   0
	move BEAT_UP,      EFFECT_FLINCH_HIT,         80, DARK,      100, 15,   20
